...
ControllerButton angleFar2HighBtn = controller[ControllerDigital::X];
ControllerButton angleFar2MidBtn = controller[ControllerDigital::B];

ControllerButton puncherOnBtn = controller[ControllerDigital::A];
ControllerButton puncherCockingBtn = controller[ControllerDigital::Y];
...
void updatePuncher() {
  ...
  if(angleFar2HighBtn.changedToPressed()) {
    angleTarget = 115;
    angleState = angleHold;
  }
